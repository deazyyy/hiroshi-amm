...
const Soldbx = styled.div`
  max-width: 436px;
  width:100%;
  margin: 20px auto 0px;
`
const AppBodyOuter = styled(AppBody)`
border:0 !important;
margin-top:20px;
`
          ...
          <CardBody>
                ...
                <AutoRow justify={isExpertMode ? 'space-between' : 'center'} style={{ padding: '0 1rem' }}>
                  <ArrowWrapper clickable>
                    <IconButton
                      ...
                      size="sm"
                    >
                      <ArrowDownIcon color="#C7EBF3" width="24px" />
                    </IconButton>
                  </ArrowWrapper>
            ...
            <BottomGrouping>
              {!account ? (
                ...
                <ButtonGrad disabled={Boolean(wrapInputError)} onClick={onWrap} fullWidth>
                  {wrapInputError ??
